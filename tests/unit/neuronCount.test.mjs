...
const OUT = {
  ...
  count_candidates: [
    { count_numeric: 125000, scope: 'adult central brain', source_pmid: '39358519', source_title: 'A central-brain connectome' },
    { count_numeric: 139255, scope: 'whole adult Drosophila brain', source_pmid: '39358518', source_title: 'A whole-brain wiring diagram' },
    { count_numeric: 125000, scope: 'adult central brain', source_pmid: '39358519', source_title: 'A central-brain connectome' } // dup
  ]
}

test('renderNeuronCountEstimate lists cited estimates and the annotated count, deduplicated', () => {
  ...
  assert.match(md, /~125,000 neurons \(adult central brain\) — A central-brain connectome — PMID 39358519/)
  assert.match(md, /~139,255 neurons \(whole adult Drosophila brain\)/)
