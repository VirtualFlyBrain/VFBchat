...
export function buildLiveDeps(p) {
  ...
  const collected = { graphs: [], thumbnails: [], expression: [], toolUsage: {}, toolRounds: 0 }
  ...
  const runTool = async (name, args) => {
    ...
    } catch { /* not an expression payload */ }
    return out
  }
