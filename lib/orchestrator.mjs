...
async function synthesise(ledger, deps, models) {
  ...
  const closingRule = '\n\nWrite the answer, never where the answer came from. Not "as stated in the documentation", "according to the documentation", "the provided evidence", "the available information", "not specified in the provided information" — say the thing itself, or say plainly what is not the case.'
  const messages = [
