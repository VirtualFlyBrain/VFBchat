...
export const PROFILES = Object.freeze({
  ...
  planner: Object.freeze({
    ...
    legacyTemperature: 0, timeoutMs: 240000, maxTokens: 16384
  }),
  ...
  extract: Object.freeze({
    ...
    legacyTemperature: 0, timeoutMs: 120000, maxTokens: 4096
  }),
  // Repairs malformed tool arguments against the tool's own JSON schema.
  args: Object.freeze({
    think: false, temperature: 0, topP: null, topK: null,
    legacyTemperature: 0, timeoutMs: 90000, maxTokens: 2048
  }),
  ...
  synth: Object.freeze({
    ...
    legacyTemperature: null, timeoutMs: 180000, maxTokens: 8192
  })
})
 ...
 * @returns {{role,model,think,temperature,timeoutMs,maxTokens,extraBody}}
 *
...
export function roleRequestOptions(role, o = {}) {
  ...
  return { role: key, model, think, temperature, timeoutMs, maxTokens, extraBody, sampling }
}
