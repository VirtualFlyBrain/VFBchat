...
// entity the planner cannot pick, and passes through untouched.
const ASPECT_ONLY_CLARIFICATION = /^\s*(?:could you |can you |please )?(?:be more specific|clarify what|specify what|(?:what|which)\s+(?:specific\s+|particular\s+)?(?:aspects?|parts?|areas?|topics?|details?|information|info|kinds? of (?:help|information|detail|data)|sorts? of (?:help|information|detail|data)))\b/i
